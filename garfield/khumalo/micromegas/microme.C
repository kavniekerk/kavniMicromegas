...
//Component class for defining the electric field and adding the components of the detector 
   ...
   comp->AddStripOnPlaneY('x',0.,0.1,0.3,"strip1");
...
//Preparing the driftlines
  ...
  driftline->DriftElectron(2,8,2,0); 
...
DriftLineRKF* drift= new DriftLineRKF();
  ...
  drift->DriftElectron(-0.1,0.6,1,0); 
 ...
 //defines the start and endpoint of a track 
...
//aval->AvalancheElectron(0.,0.0125,0.,0,0.1,1.,0.,0);
